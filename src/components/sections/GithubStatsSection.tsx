      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-panel rounded-3xl p-8 border border-white/10 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 border-b border-white/10 pb-6">
            <div className="flex items-center gap-4 text-center md:text-left">
              ...
              <div>
                ...
                <h3 className="text-2xl font-extrabold text-white">GitHub Activity & Repositories</h3>
              </div>
            </div>
            ...
            <a
              ...
              className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 text-xs font-mono text-slate-200 flex items-center gap-2 transition-colors"
            >
          ...
          {isUserLoading ? (
            ...
            <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-300 text-xs flex items-center justify-between mb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
              <div className="bg-white/5 p-4 rounded-2xl border border-white/5 text-center">
                ...
                <div className="text-xs font-mono text-slate-400 mt-1 flex items-center justify-center gap-1">
              ...
              <div className="bg-white/5 p-4 rounded-2xl border border-white/5 text-center">
                <div className="text-2xl font-extrabold text-cyan-300">100%</div>
                <div className="text-xs font-mono text-slate-400 mt-1 flex items-center justify-center gap-1">
              ...
              {isReposLoading
                ...
                : repos?.map((repo) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="glass-card rounded-2xl p-5 border border-white/10 hover:border-brand-cyan/40 transition-all flex flex-col justify-between group"
                    >
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <h5 className="font-bold text-white text-base group-hover:text-brand-cyan transition-colors flex items-center gap-2">
                      ...
                      <div className="flex items-center justify-between text-xs font-mono text-slate-400 pt-3 border-t border-white/5">
                        <span className="px-2.5 py-0.5 rounded bg-white/5 text-cyan-300 border border-white/5">
