  ...
  return (
    <section id="services" className="py-24 relative z-10 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:border-brand-cyan/50 hover:bg-white/10 text-white transition-all shadow-md group"
            >
      ...
      >
        ...
        <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-dark-bg via-dark-bg/80 to-transparent z-20" />
